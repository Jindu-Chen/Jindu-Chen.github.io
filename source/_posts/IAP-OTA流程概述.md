...
问题排查解决分析：
- 通过此前已成功实现内核复位升级的rt-thread业务工程，进行对比删减，排查问题
- 当注释掉其大部分的业务设计后，发现此可行工程也无法正常内核复位升级
- 初步规律为：原有工程能够内核复位升级至删减后的工程、删减后的工程却无法内核复位升级至原有的工程


- 在测试过程中，跳转至bootloader时，串口有非预期的信息打印，并非代码指示。
